...
class SelectM23 {
    ...
    set_placeholder(empty = false) {
        if (empty) {
            ...
            this.wrapper.style.background = `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' version='1.1' height='50px' width='200px'><text x='5' y='18' fill='black' font-size='14'>${this.placeholder}</text></svg>") no-repeat`;
    }
