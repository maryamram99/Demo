...
Please install and activate it before starting to use the theme Junotoys.
...
Theme documentation is available on http://junotoys.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Junotoys is Fontello.
