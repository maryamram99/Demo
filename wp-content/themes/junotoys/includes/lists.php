...
if ( ! function_exists('junotoys_get_not_selected_text') ) {
	/**
	 ...
	 */
	function junotoys_get_not_selected_text( $label ) {
		return apply_filters( 'junotoys_filter_not_selected_text',
								sprintf( apply_filters( 'junotoys_filter_not_selected_mask', __( '- %s -', 'junotoys' ) ), $label )
							);
	}
}

if ( ! function_exists( 'junotoys_get_list_range' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'junotoys_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function junotoys_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'junotoys' ),
				0         => esc_html__( 'No', 'junotoys' ),
			)
		);
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'junotoys_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'junotoys' ),
			'hidden'  => esc_html__( 'Hidden', 'junotoys' ),
		);
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'junotoys' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'junotoys' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'junotoys' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'junotoys' ),
...
if ( ! function_exists( 'junotoys_get_list_hovers' ) ) {
	...
	function junotoys_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'junotoys' ),
				'icon'    => esc_html__( 'Icon', 'junotoys' ),
				'icons'   => esc_html__( 'Icons', 'junotoys' ),
				'zoom'    => esc_html__( 'Zoom', 'junotoys' ),
				'fade'    => esc_html__( 'Fade', 'junotoys' ),
				'slide'   => esc_html__( 'Slide', 'junotoys' ),
				'pull'    => esc_html__( 'Pull', 'junotoys' ),
				'border'  => esc_html__( 'Border', 'junotoys' ),
				'excerpt' => esc_html__( 'Excerpt', 'junotoys' ),
				'info'    => esc_html__( 'Info', 'junotoys' ),
			)
		);
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'junotoys_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'junotoys' ),
				'fullpost' => esc_html__( 'Full post', 'junotoys' ),
		);
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'junotoys_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function junotoys_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'junotoys' ),
...
if ( ! function_exists( 'junotoys_get_list_sidebars' ) ) {
	 ...
	 */
	function junotoys_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = junotoys_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			junotoys_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = junotoys_array_merge( array( 'hide' => junotoys_get_not_selected_text( esc_html__( 'Select widgets', 'junotoys' ) ) ), $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_sidebars_positions' ) ) {
	...
	function junotoys_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'junotoys' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'junotoys' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'junotoys' ),
...
if ( ! function_exists( 'junotoys_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'junotoys' ),
				'below' => esc_html__( 'Below the content', 'junotoys' ),
				'float' => esc_html__( 'Floating bar', 'junotoys' ),
			)
		);
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'junotoys_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'junotoys_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'junotoys_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'junotoys_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'junotoys_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'junotoys_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_header_positions( $prepend_inherit = false ) {
		$list = apply_filters( 'junotoys_filter_list_header_positions', array(
			'default' => esc_html__( 'Default', 'junotoys' ),
			'over'    => esc_html__( 'Over', 'junotoys' ),
			'under'   => esc_html__( 'Under', 'junotoys' ),
		) );
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'junotoys_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'junotoys_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_body_styles' ) ) {
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function junotoys_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'junotoys' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'junotoys' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'junotoys_filter_allow_fullscreen', $force_fullscreen || junotoys_get_theme_setting( 'allow_fullscreen' ) || junotoys_get_edited_post_type() == 'page' ) ) {
			if ( junotoys_get_theme_setting( 'allow_fullwide', true ) ) {
				$list['fullwide']   = array(
										'title' => esc_html__( 'Fullwidth', 'junotoys' ),
										'icon'  => 'images/theme-options/body-style/fullwide.png',
										);
			}
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'junotoys' ),
...
if ( ! function_exists( 'junotoys_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function junotoys_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'junotoys_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'junotoys' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'junotoys' ),
...
if ( ! function_exists( 'junotoys_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function junotoys_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'junotoys' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'junotoys' ),
...
if ( ! function_exists( 'junotoys_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'junotoys' ),
				'date'       => esc_html__( 'Published date', 'junotoys' ),
				'modified'   => esc_html__( 'Modified date', 'junotoys' ),
				'views'      => esc_html__( 'Views', 'junotoys' ),
				'likes'      => esc_html__( 'Likes', 'junotoys' ),
				'comments'   => esc_html__( 'Comments', 'junotoys' ),
				'share'      => esc_html__( 'Share links', 'junotoys' ),
				'categories' => esc_html__( 'Categories', 'junotoys' ),
				'edit'       => esc_html__( 'Edit link', 'junotoys' ),
			)
		);
...
if ( ! function_exists( 'junotoys_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'junotoys_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function junotoys_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'junotoys' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'junotoys' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'junotoys_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? junotoys_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'junotoys_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function junotoys_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'junotoys_filter_list_single_styles', junotoys_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? junotoys_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'junotoys_get_list_categories' ) ) {
	...
	function junotoys_get_list_categories( $prepend_inherit = false ) {
		$list = junotoys_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'junotoys_filter_term_name', $cat->name, $cat );
				}
			}
			junotoys_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_terms' ) ) {
	...
	function junotoys_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = junotoys_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'junotoys_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			junotoys_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_posts_types' ) ) {
	...
	function junotoys_get_list_posts_types( $prepend_inherit = false ) {
		$list = junotoys_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'junotoys_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'junotoys' ),
				)
			);
			junotoys_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_posts' ) ) {
	...
	function junotoys_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		...
		$list = junotoys_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? junotoys_get_not_selected_text( esc_html__( 'Not selected', 'junotoys' ) ) : $opt['not_selected'];
			}
			$args = array(
			...
			junotoys_storage_set( $hash, $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_users' ) ) {
	...
	function junotoys_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = junotoys_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = junotoys_get_not_selected_text( esc_html__( 'Not selected', 'junotoys' ) );
			$users        = get_users(
				array(
			...
			junotoys_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_menus' ) ) {
	...
	function junotoys_get_list_menus( $prepend_inherit = false ) {
		$list = junotoys_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			...
			junotoys_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'junotoys_get_list_icons' ) ) {
	 ...
	 */
	function junotoys_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'junotoys_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			$lists = array();
			if ( 'icons' == $style ) {
				$lists[ $style ] = junotoys_array_from_list( junotoys_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = junotoys_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = junotoys_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'junotoys_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'junotoys_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function junotoys_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : junotoys_parse_icons_classes( junotoys_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : junotoys_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? junotoys_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'junotoys' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'junotoys_get_list_images' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'junotoys_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function junotoys_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'junotoys_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'junotoys' ),
				'link2'   => esc_html__( 'Accent 2', 'junotoys' ),
				'link3'   => esc_html__( 'Accent 3', 'junotoys' ),
