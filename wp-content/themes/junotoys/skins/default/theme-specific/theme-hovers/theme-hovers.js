	...
	'action.init_hidden_elements', function(e, cont) {
		...
		if (JUNOTOYS_STORAGE['button_hover'] && JUNOTOYS_STORAGE['button_hover'] != 'default') {
			jQuery(
				...
				// Theme tabs
				+ '.junotoys_tabs .junotoys_tabs_titles li a:not([class*="sc_button_hover_"]),'
				// More link
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + JUNOTOYS_STORAGE['button_hover'] );
			...
			jQuery(
				...
				// Theme tabs
				+ '.junotoys_tabs .junotoys_tabs_titles li a:not([class*="sc_button_hover_style_"]),'
				// Tag cloud
			...
			).removeClass( 'sc_button_hover_' + JUNOTOYS_STORAGE['button_hover'] );
