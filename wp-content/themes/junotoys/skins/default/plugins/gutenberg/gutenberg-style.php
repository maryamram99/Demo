...
if ( ! function_exists( 'junotoys_gutenberg_get_css' ) ) {
	add_filter( 'junotoys_filter_get_css', 'junotoys_gutenberg_get_css', 10, 2 );
	function junotoys_gutenberg_get_css( $css, $args ) {
