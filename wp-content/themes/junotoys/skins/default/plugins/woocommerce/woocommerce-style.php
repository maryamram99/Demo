...
if ( ! function_exists( 'junotoys_woocommerce_get_css' ) ) {
	add_filter( 'junotoys_filter_get_css', 'junotoys_woocommerce_get_css', 10, 2 );
	function junotoys_woocommerce_get_css( $css, $args ) {
...
$fdir = junotoys_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
